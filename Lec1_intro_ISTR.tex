...
\begin{center}
\begin{figure}[h!]
	\subfigure{\includegraphics[trim=0 300 0 0,clip,width=0.7\textwidth]{FIGURES/1_EconModel}
	}      
...
%    \draw node[opacity=0.3] at (14.5,-0.4) {\includegraphics[width=0.3\paperwidth]{baby_logo.png}};%
...
{%
  %\begin{figure}[b!]
  \begin{tikzpicture}
	\draw node[opacity=0] at (15,6) {\includegraphics[width=0.3\paperwidth]{FIGURES/yin_yang.png}};%
    \draw node[opacity=0.05] at (14.5,-0.4) {\includegraphics[width=0.3\paperwidth]{FIGURES/yin_yang.png}};%
    %\draw node[opacity=0.8] at (15.3,6) {\includegraphics[width=0.23\paperwidth]{../PSE_logo.png}};%
	\draw node[opacity=0] at (10.3,-1.4) {\includegraphics[width=0.37\paperwidth]{FIGURES/yin_yang.png}};%
	\draw node[opacity=0] at (6,-1.4) {\includegraphics[width=0.3\paperwidth]{FIGURES/yin_yang.png}};%
  \end{tikzpicture}
  %\end{figure}
}
...
%	%\subfigure{\includegraphics<1>[trim=80 60 100 70,clip,width=0.75\textwidth]{FIGURES/3_Autarky}
%	%}
%	\subfigure{\includegraphics[trim=0 0 0 0,clip,width=0.75\textwidth]{FIGURES/6_GE}
%	}      
%	%\subfigure{\includegraphics[trim=0 00 0 00,clip,width=0.6\textwidth]{FIGURES/5_CB_balance_sheet_OMO}
%	%} 
%	
...
\item $T$ is tax (assumed lump-sum, i.e.~independent of any characteristics)
\item[\rarr] $Y-T$ is \tb{disposable income} 
\end{itemize}
\vspace{1cm}

How to measure the reaction of consumption to a change in disposable income? \\ Take a derivative: $$mpc = \frac{\partial C}{\partial (Y-T)}$ is the \tb{marginal propensity to consume}. An assumption $0<mpc\leq 1$ is central to Keynesian analysis. 
\end{frame}
...
\textbf{A rise in the real interest discourages investment}: borrowing becomes more expensive, future incomes are valued less (discounting). 
\end{frame}
...
\begin{mytemize}
    ...
    \item $Y^*$ in $Ex$ and $Y$ in $Im$ are shortcuts: all determinants of foreign demand might be relevant
\end{mytemize}
...
What is the influence of $Y$
 on DD? Depends on two derivatives:  and $\frac{\partial TB}{\partial Y}$ 
\begin{mynumerate}
\item $\frac{\partial C}{\partial (Y-T)}$, which is the \tb{marginal propensity to consume (mpc)} 
\end{mynumerate}
...
%\caption{Figure. Capital share US, 1946-2018
	%\subfigure{\includegraphics<1>[trim=80 60 100 70,clip,width=0.75\textwidth]{FIGURES/3_Autarky}
	%}
	\subfigure{\includegraphics[trim=0 0 0 0,clip,width=0.5\textwidth]{FIGURES/6_IScurve}
	}      
	%\subfigure{\includegraphics[trim=0 00 0 00,clip,width=0.6\textwidth]{FIGURES/5_CB_balance_sheet_OMO}
	%} 
...
%	%\subfigure{\includegraphics<1>[trim=80 60 100 70,clip,width=0.75\textwidth]{FIGURES/3_Autarky}
%	%}
%	\subfigure{\includegraphics[trim=0 0 0 0,clip,width=0.5\textwidth]{FIGURES/6_IScurveShift}
%	}      
%	%\subfigure{\includegraphics[trim=0 00 0 00,clip,width=0.6\textwidth]{FIGURES/5_CB_balance_sheet_OMO}
%	%} 
%	
...
%\caption{Figure. Capital share US, 1946-2018
	%\subfigure{\includegraphics<1>[trim=80 60 100 70,clip,width=0.75\textwidth]{FIGURES/3_Autarky}
	%}
	\subfigure{\includegraphics[trim=0 0 0 0,clip,width=0.4\textwidth]{FIGURES/6_TRcurve}
	}      
	%\subfigure{\includegraphics[trim=0 00 0 00,clip,width=0.6\textwidth]{FIGURES/5_CB_balance_sheet_OMO}
	%} 
...
\begin{center}
\begin{figure}[h!]
	\subfigure{\includegraphics[trim=0 0 0 0,clip,width=0.75\textwidth]{FIGURES/6_LMcurve}
	}      
\end{figure}
\begin{minipage}{1.0\columnwidth}
\tiny	
...
%\caption{Figure. Capital share US, 1946-2018
	%\subfigure{\includegraphics<1>[trim=80 60 100 70,clip,width=0.75\textwidth]{FIGURES/3_Autarky}
	%}
	\subfigure{\includegraphics[trim=0 0 0 0,clip,width=0.9\textwidth]{FIGURES/6_MMequilibrium}
	}      
	%\subfigure{\includegraphics[trim=0 00 0 00,clip,width=0.6\textwidth]{FIGURES/5_CB_balance_sheet_OMO}
	%} 
...
%\caption{Figure. Capital share US, 1946-2018
	%\subfigure{\includegraphics<1>[trim=80 60 100 70,clip,width=0.75\textwidth]{FIGURES/3_Autarky}
	%}
	\subfigure{\includegraphics[trim=0 0 0 0,clip,width=0.9\textwidth]{FIGURES/6_TRcurveSlope}
	}      
	%\subfigure{\includegraphics[trim=0 00 0 00,clip,width=0.6\textwidth]{FIGURES/5_CB_balance_sheet_OMO}
	%} 
...
%\caption{Figure. Capital share US, 1946-2018
	%\subfigure{\includegraphics<1>[trim=80 60 100 70,clip,width=0.75\textwidth]{FIGURES/3_Autarky}
	%}
	\subfigure{\includegraphics[trim=0 0 0 0,clip,width=0.5\textwidth]{FIGURES/6_TRcurveShift}
	}      
	%\subfigure{\includegraphics[trim=0 00 0 00,clip,width=0.6\textwidth]{FIGURES/5_CB_balance_sheet_OMO}
	%} 
...
\caption{Figure. Nominal short-term interest rates in the US, Germany and UK}
	%\subfigure{\includegraphics<1>[trim=80 60 100 70,clip,width=0.75\textwidth]{FIGURES/3_Autarky}
	%}
	\subfigure{\includegraphics[trim=0 0 0 0,clip,width=0.8\textwidth]{FIGURES/6_NominalRates}
	}      
	%\subfigure{\includegraphics[trim=0 00 0 00,clip,width=0.6\textwidth]{FIGURES/5_CB_balance_sheet_OMO}
	%} 
...
%\caption{Figure. Capital share US, 1946-2018
	%\subfigure{\includegraphics<1>[trim=80 60 100 70,clip,width=0.75\textwidth]{FIGURES/3_Autarky}
	%}
	\subfigure{\includegraphics[trim=0 0 0 0,clip,width=0.5\textwidth]{FIGURES/6_MacroEqu}
	}      
	%\subfigure{\includegraphics[trim=0 00 0 00,clip,width=0.6\textwidth]{FIGURES/5_CB_balance_sheet_OMO}
	%} 
...
%\caption{Figure. Capital share US, 1946-2018
	%\subfigure{\includegraphics<1>[trim=80 60 100 70,clip,width=0.75\textwidth]{FIGURES/3_Autarky}
	%}
	\subfigure{\includegraphics[trim=0 0 0 0,clip,width=0.6\textwidth]{FIGURES/6_ISTRadjustments_IS}
	}      
	%\subfigure{\includegraphics[trim=0 00 0 00,clip,width=0.6\textwidth]{FIGURES/5_CB_balance_sheet_OMO}
	%} 
...
%\caption{Figure. Capital share US, 1946-2018
	%\subfigure{\includegraphics<1>[trim=80 60 100 70,clip,width=0.75\textwidth]{FIGURES/3_Autarky}
	%}
	\subfigure{\includegraphics[trim=0 0 0 0,clip,width=0.6\textwidth]{FIGURES/6_ISTRadjustments_TR}
	}      
	%\subfigure{\includegraphics[trim=0 00 0 00,clip,width=0.6\textwidth]{FIGURES/5_CB_balance_sheet_OMO}
	%} 
...
%	%\subfigure{\includegraphics<1>[trim=80 60 100 70,clip,width=0.75\textwidth]{FIGURES/3_Autarky}
%	%}
%	\subfigure{\includegraphics[trim=0 0 0 0,clip,width=0.45\textwidth]{FIGURES/6_ISTRmodelZLB}
%	}      
%	%\subfigure{\includegraphics[trim=0 00 0 00,clip,width=0.6\textwidth]{FIGURES/5_CB_balance_sheet_OMO}
%	%} 
%	
