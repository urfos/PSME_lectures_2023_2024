...
% TITLE
%------------------------------------------------------------------------------------
\title[PSME]{Macroeconomics\\ Lecture 5 -- Real Business Cycles} 
...
\item Big "Keynesian macroeconometric models" group  led by Kennedy's Council of Economic Advisers
  ...
  \end{mytemize}
\item Application of IS-LM, Mundell-Flemming, AD-AS models to the data. Models linear \rarr represented as system of linear equations and estimated by least-squares methods:
\end{mytemize}
\begin{figure}[h!]
%\caption{Figure. Net}
