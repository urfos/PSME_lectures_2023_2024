...
%---FRAME------------------------------------------------------------------------------
\begin{frame}
\frametitle{PSME Macroeconomics: Syllabus}
...
% 2021
\midrule
1  & 20 sept 	& Introduction, IS-TR, & [BW] Ch.10  \\
2  & 27 sept	& IS-TR-IFM, Intro to Dynamics  & [BW] Ch.11, ref. \\
3  & 4 oct	&AD-AS 	& 	 [BW] Ch.13\\
4  & \ 11 oct    &  Consumption, Savings, Balance of Payments &  [GLS] Ch.9, [SUW] Ch. 2, 3.1 \\
5  & 18 oct		& Permanent Income Hypothesis &  	[GLS] Ch.10, [U] Ch. 1	\\
-  & 25 oct		& Mid-term &  \\	
-- & 1 nov	&  \textit{Autumn Break}  \hfill	&  -- \\
6  & 8 nov		& Labor, intro to Real Business Cycles (RBC)  & [GLS] Ch.12, ref. \\
7  & \ 15 nov		& RBC in Closed Economy & 	[S] RBC pt.1 \\
8  & \ 22 nov & RBC in Closed Economy II & [S] RBC pt.2 \\
9 & \ 29 nov	 & RBC	in Small Open Economy, simplified Large Op. Ec. & [U] Ch. 3, [SUW] Ch. 6 \\
10  & 6 dec	& New Keynesian Model I -- flexible prices    & 	[G] Ch.2	\\
11  & 13 dec	& New Keynesian Model II	\& Time Consistency & [G] Ch.3, 5 \\  
12 & 20 dec 	& Fiscal Policy	&    [GLS] Ch. 12	\\
\bottomrule
\end{tabular}
}
\vfill
